...
// 2. Remover o Bloco 2 original (apenas a seção de onde tiramos o faq-accordion)
...
// Ajustar background do Ideal For para não ficar interiço com o Hero
$('.ideal-for-section').attr('style', 'background: #ffffff; padding: 4rem 0; border-top: 1px solid rgba(235,182,108,0.2); border-bottom: 1px solid rgba(235,182,108,0.2);');
$('.benefits-section').attr('style', 'background: #fdfaf7; padding: 4rem 0;');
...
// Perguntas Frequentes (a segunda faq-section)
const secondFaqSectionHTML = getAndRemove('section.faq-section');

// Remover Assortment
getAndRemove('.assortment-section');

// Create Recipes Carousel (usando "receita01.webp" no singular e com padding abaixo)
const recipesCarouselHTML = `
    <!-- Recipes Carousel -->
    <section class="recipes-carousel-section" style="overflow: hidden; padding: 4rem 0 3rem 0; background: var(--bg-light);">
        ...
        <div class="carousel-wrapper" style="background: transparent; padding: 0 0 1rem 0;">
